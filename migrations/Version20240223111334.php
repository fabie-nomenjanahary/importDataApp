 ...
 */
final class Version20240223111334 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE evenement (id INT AUTO_INCREMENT NOT NULL, vehicule_id INT DEFAULT NULL, origine_event VARCHAR(20) DEFAULT NULL, commentaire VARCHAR(50) DEFAULT NULL, date_event DATE DEFAULT NULL, date_dernier_event DATE DEFAULT NULL, INDEX IDX_B26681E4A4A3511 (vehicule_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE evenement ADD CONSTRAINT FK_B26681E4A4A3511 FOREIGN KEY (vehicule_id) REFERENCES vehicule (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evenement DROP FOREIGN KEY FK_B26681E4A4A3511');
